...
| WIN-SC-001 | Start Center Home/shared shell | `sfx2/source/dialog/backingwindow.cxx`, `sfx2/uiconfig/ui/startcenter.ui` | Material source slice compiled; scoped runtime accepted | E-BLD, E-SC | SC-01 dimensions, width/scale/render MATRIX, PX, FLOW, A11Y, LOC, PERF, COMPAT | `✓ ✓ ✓ △ △ △ · · ·` |
