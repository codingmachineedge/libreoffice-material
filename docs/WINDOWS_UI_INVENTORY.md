...
| WIN-SYS-008 | onboarding/welcome | shared startup path; former Welcome controller/UI removed | canonical no-nag contract implemented in source; automatic Welcome/What’s New UI and configuration removed, explicit release notes retained; build/runtime pending | none | BUILD, FLOW, A11Y, LOC, COMPAT | `✓ ✓ · · · · · · ·` |
