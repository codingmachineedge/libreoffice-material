...
Accepted LibreOffice Material build/UI evidence entries: **6 runs / 16 screenshots**.
The public canonical gallery uses **9 screenshots** (3 newest-source light,
3 corrected-payload dark, and 3 corrected-payload forced high contrast); the
7 screenshots from three earlier accepted light runs remain historical proof.
