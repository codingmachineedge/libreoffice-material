...
| Verified UI screenshots | 9 canonical Start Center captures: 3 each in light, dark, and forced high contrast | The newest exact `7029dccf4` build supplies Light Home/focus/Templates under [`20260720-135505-7029dccf40-windows-headless-light`](docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/results.json) and Dark Home/focus/Templates under [`20260720-140327-7029dccf40-windows-headless-dark`](docs/evidence/runs/20260720-140327-7029dccf40-windows-headless-dark/); forced-high-contrast Home/focus/Templates remain under [`20260720-033338-fbba560e27-windows-headless-highcontrast`](docs/evidence/runs/20260720-033338-fbba560e27-windows-headless-highcontrast/). Earlier runs remain historical proof; scaling, accelerated rendering, localization, and suite surfaces remain open |
...
<p align="center">
  <a href="docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/screenshots/start-center-light.png"><img src="docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/screenshots/start-center-light.png" alt="Exact-build LibreOfficeDev light Start Center Home and Recent Documents view running on an off-screen Windows desktop" width="32%"></a>
  <a href="docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/screenshots/start-center-light-keyboard-focus.png"><img src="docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/screenshots/start-center-light-keyboard-focus.png" alt="Exact-build LibreOfficeDev light Start Center with a visible keyboard focus ring on Open File" width="32%"></a>
  <a href="docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/screenshots/start-center-templates-light.png"><img src="docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/screenshots/start-center-templates-light.png" alt="Exact-build LibreOfficeDev light Start Center Templates gallery after a background navigation smoke action" width="32%"></a>
</p>
...
trio comes from the MSI built at exact source commit `7029dccf40b4d9851e0ea9f9bb2c03ad5ae405b3`;
the dark trio comes from that same exact build, while the forced-high-contrast
...
[canonical light manifest](docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/manifest.json),
[results](docs/evidence/runs/20260720-135505-7029dccf40-windows-headless-light/results.json),
